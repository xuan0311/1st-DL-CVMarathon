...
class YoloNet(Net):
  ...
  def __init__(self, common_params, net_params, test=False):
    ...
    #process params
    self.image_size = int(common_params['image_size']) #圖像大小 448
    self.num_classes = int(common_params['num_classes']) #類別數量 20
  ...
  def inference(self, images):
    ...
    #Dropout 包括在訓練中每次更新時， 將輸入單元的依照50%隨機設置為0， 這有助於防止過擬合
  ...
  def iou(self, boxes1, boxes2):
    ...
    #tf.pack:將一個R維張量列表沿著axis軸組合成一個R+ 1維的張量。
